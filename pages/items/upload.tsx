  ...
  return (
    <div className="px-4 py-16">
      <div>
        <div>
          <label
            className="w-full flex items-center justify-center border-2 border-dashed
                       border-gray-300 h-48 rounded-md text-gray-600 hover:text-orange-500
                       hover:border-orange-500 cursor-pointer text-sm font-medium text-gray-700"
          >
            <svg
              className="h-12 w-12"
              stroke="currentColor"
