...
const CommunityPostDetail: NextPage = () => {
  return (
    <div>
      <span
        className="inline-flex my-3 ml-4 items-center px-2.5 py-0.5 rounded-full text-xs font-medium
      ...
      <div className="px-4">
        ...
        />
        <button
          className="mt-2 w-full bg-orange-500 hover:bg-orange-600 text-white py-2 px-4 border
